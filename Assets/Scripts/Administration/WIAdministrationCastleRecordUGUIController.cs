...
{
    public sealed class WIAdministrationCastleRecordUGUIController : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (administrationController != null) administrationController.UGUICastleRecordRequested += Open;
        }
        ...
        private void Open()
        {
            if (administrationController.TryGetUGUICastleRecordSnapshot(out WIAdministrationCastleRecordSnapshot snapshot) == false)
            {
                return;
            }
