...
{
    public sealed class WIAdministrationDiplomacyUGUIController : MonoBehaviour
    {
        ...
        {
            if (administrationController == null) administrationController = FindFirstObjectByType<WIAdministrationUIController>();
            if (administrationController != null) administrationController.UGUIDiplomacyRequested += Open;
        }
        ...
        {
            if (administrationController.TryGetUGUIDiplomacyPanel(mode, factionId, out snapshot, out string error) == false)
            {
        ...
        private void SelectCard(int index)
        {
            ...
            if (administrationController.ExecuteUGUIDiplomacyAction(card.Action, factionId, card.Id, out string error) == false)
            {
                messageLabel.gameObject.SetActive(true);
                messageLabel.text = error;
                return;
