...
{
    public sealed class WIAdministrationTurnFollowupUGUIController : WIAdministrationUGUIPanelController
    {
        ...
        private void Open()
        {
            if (administrationController.TryGetUGUITurnFollowupSnapshot(out WIAdministrationTurnFollowupSnapshot snapshot) == false)
            {
                return;
            }
        ...
        {
            if (administrationController.ResolveUGUITurnFollowup(choiceIndex) == false)
            {
                return;
            }
            modal.Hide();
