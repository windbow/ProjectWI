...
{
    public sealed class WIAdministrationFactionUGUIController : WIAdministrationUGUIPanelController
    {
        ...
        private void OnEnable()
        {
            ...
            {
                administrationController.UGUIFactionRequested += Open;
            }
        }
        ...
        {
            modal.Show("대륙 진영 정세");
            if (administrationController.TryGetUGUIFactionSnapshot(out WIAdministrationFactionSnapshot snapshot)
                == false)
            {
