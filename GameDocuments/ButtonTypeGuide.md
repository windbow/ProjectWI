...
|---|---|---|---|---|
| **A Type** | 전략 기본 명령 버튼 | `button_flat_normal.png` | 전략·내정 화면의 일반 행동, 모달 기본 버튼 | 좌우 18 / 상하 16 |
| **B Type** | 전략 주요 명령 버튼 | `button_flat_primary.png` | 선택 상태, 확인, 다음 단계와 주요 행동 | 좌우 18 / 상하 16 |
| **C Type** | 전략 위험 명령 버튼 | `button_flat_danger.png` | 파기, 후퇴 확인, 위험 행동과 경고성 명령 | 좌우 18 / 상하 16 |
| **D Type** | 전역·패널 동작 버튼 | `right_action_button.png` | 하단 전역 명령(군사~월보), 우측 정보·성 명령 패널의 독립 행동 | 좌우 28 / 상하 20 |
...
- 전략 지도·성 내정·공통 모달에서는 **A/B/C Type**을 우선합니다.
- 하단 전역 명령 바의 군사~월보 버튼과 우측 패널의 독립 행동 버튼은 **D Type**을 사용합니다.
