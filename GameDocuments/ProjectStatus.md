...
- 2026-08-30: 시설 UI 납품 전 해상도 대응을 추가 검증함. Unity Game View 1366×768과 2560×1440에서 아발론 영지 전경의 성관·시장·훈련소·선술집 핫스팟, 하단 주둔 영웅·특화 시설·이번 달 중점 트레이, 기본 시설 4버튼 모달을 플레이 모드로 확인했으며 화면 밖 잘림·버튼 겹침·흰 배경 재발이 없음을 확인함. 해상도별 QA 캡처를 `Assets/Screenshots/Administration`에 저장했고 Console Error 0건을 확인함.
